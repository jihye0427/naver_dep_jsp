...
public class BoardController extends HttpServlet {
	...
	private Map<String, Action> boardMap=new Hashtable<String, Action>();
   ...
   //BoardController 최초 실행시 한번만 실행되는 메서드...
	...
	public void init() throws ServletException {
		...
		try {
			Properties prop=Resources.getResourceAsProperties("/action/board/boardClass-info.properties");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Action action=boardMap.get(key);
